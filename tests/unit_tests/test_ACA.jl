...
@testset "ACA tests" begin
    ...
    @testset "computeRHSContributionACA" begin
        ...
        test_U, test_V = computeRHSContributionACA(computeMatrixEntry, approximation_tol, num_rows, num_cols)
        ...
        test_U, test_V = computeRHSContributionACA(computeMatrixEntry, approximation_tol, length(test_node.element_idxs), length(src_node.element_idxs))
