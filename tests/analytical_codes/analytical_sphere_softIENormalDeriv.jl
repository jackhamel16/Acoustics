...
for run_idx in 1:length(num_elements)
    ...
    mag_filename = string("sources_mag_softIENormalDeriv_sphere",num_elements[run_idx])
...
savefig("sphere_convergence_results_softIENormalDeriv")
...
#output data
output_file = open("sphere_convergence_data_softIENormalDeriv.txt", "w")
